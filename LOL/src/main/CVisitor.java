...
import gen.LOLBaseVisitor;
import gen.LOLParser;
import gen.LOLParser.Repeat_loopContext;
import utils.ErrorMessages;

public class CVisitor extends LOLBaseVisitor<TerminalNode>
{
     ...
     */
    @Override public TerminalNode visitProgram(LOLParser.ProgramContext ctx)
    {
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitStat(LOLParser.StatContext ctx)
    {
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitDeclaration(LOLParser.DeclarationContext ctx)
    {
        ...
        if(ctx.expr() != null)
            ...
            a = new TerminalNodeImpl(new CommonToken(LOLParser.LITERAL, "ASSIGN"));
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitAssignment(LOLParser.AssignmentContext ctx)
    {
        ...
        else return new TerminalNodeImpl(new CommonToken(LOLParser.LITERAL, "NULL"));
    }

    @Override public TerminalNode visitRepeat_loop(Repeat_loopContext ctx)
    {
        ...
        text.add(exitLabel);
        return new TerminalNodeImpl(new CommonToken(LOLParser.BOOLEAN, "WHILE"));
    }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitConditional(LOLParser.ConditionalContext ctx)
    {
        List<LOLParser.ExprContext> expressions = ctx.expr();
        String label = CodeEmitter.getLabel(labelCount);
        text.add(label);
        labelCount++;
        ...
        int block_count = 0;
        for (LOLParser.ExprContext exp : expressions)
        {
        ...
        return new TerminalNodeImpl(new CommonToken(LOLParser.BOOLEAN, "true"));
    }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitFunc_def(LOLParser.Func_defContext ctx)
    {
        ...
        return new TerminalNodeImpl(new CommonToken(LOLParser.NUMBER, "1"));
    }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitBlock(LOLParser.BlockContext ctx)
    {
        // don't execute expr yet. this would be the return statement
        List<LOLParser.StatContext> stmts = ctx.stat();

        for (LOLParser.StatContext stmt : stmts)
            visit(stmt);
        if(ctx.expr() != null)
        {
        ...
        return new TerminalNodeImpl(new CommonToken(LOLParser.LITERAL, "block"));
    }
    /**
     * {@inheritDoc}
     *
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitExpr(LOLParser.ExprContext ctx)
    {
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    @Override public TerminalNode visitFunc_call(LOLParser.Func_callContext ctx)
    {
        ...
        else
        {
            ...
            for (LOLParser.ExprContext expression : expressions)
            {
        ...
        //node = new TerminalNodeImpl(new CommonToken(LOLParser.LITERAL, "TEST"));
        return node;
    }
    ...
    {
        if (type.equals("NUMBER")) return LOLParser.NUMBER;
        else if (type.equals("TEXT")) return LOLParser.TEXT;
        else if (type.equals("BOOLEAN")) return LOLParser.BOOLEAN;
        // todo: else assume text?
        return LOLParser.TEXT;
    }
    ...
    private String getExprCtxType(LOLParser.ExprContext ctx)
    {
    ...
    private String getCtxOperation(LOLParser.ExprContext ctx)
    {
        if(ctx == null)
            return "ERROR";
    ...
    private TerminalNode processExprContext(LOLParser.ExprContext ctx)
    {
        ...
        else
        {
            ...
            if (ctx.NOT() != null)
            {
                ...
                return new TerminalNodeImpl(new CommonToken(LOLParser.BOOLEAN, "NOT"));
            }
            try
            {
                loperand = getOperandValue(visit(ctx.expr(0)).getSymbol());
            ...
            else if (getExprCtxType(ctx).equals("BOOL OPERATION"))
            {
                ...
                node = new TerminalNodeImpl(new CommonToken(LOLParser.BOOLEAN, operation));
            }
        }
        return node;
    }
