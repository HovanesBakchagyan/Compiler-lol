...
public class ValueBuilder
{
    ...
    public static Value getValue(Token token, Map<String, Value> map)
    {
        ...
        else if (token.getType() == LOLParser.BOOLEAN)
        {
            return new Bool(token.getText());
        }
        else if (token.getType() == LOLParser.TEXT)
        {
