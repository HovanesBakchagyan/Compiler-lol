 ...
 */
public class LOLCompiler
{
    private final LOLLexer lexer;
    private final LOLParser parser;
    private final ParseTree parseTree;
    private final CVisitor visitor;
    private final String sourceFilename;
    private final String workingDirectory;

    public LOLCompiler(String filepath) throws IOException
    {
        FileUtils.ensureFileExists(filepath);
        FileUtils.ensureFileExtension(filepath, ".LOL");
        ...
        this.lexer = new LOLLexer(sourceFileStream);
        this.parser = new LOLParser(new CommonTokenStream(lexer));
        this.parser.addParseListener(new LOLBaseListener());
    ...
    /**
     * Compile single LOL source file.
     * Note: Jasmin and class files are generated in same directory as LOL file.
     */
    public void compile()
    {
